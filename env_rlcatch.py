...
#         ]
#         self.bomb_img = pygame.image.load("assets/bomb.png") #-50
...
#         self.basket_x = grid_width // 2 #initial postn at middle
...
#         self.object_x = self.throw_x #fruit x coord 
#         self.object_y = 0 #top row
...
#         # No object then human must throw
...
#                 # Missing fruit but no life lost
#                 else:
#                     reward -= 5
#             else:  # bomb
#                 if caught:
...
#             if self.lives <= 0 or self.bombs_caught >= 4 or self.score >= 200:
#                 done = True
...
class FruitCatcherEnv:
    ...
    def step(self, action):
        ...
        # DEBUG
        #print(f"OBJ FALL: x={self.object_x} y={self.object_y} type={self.object_type}")
